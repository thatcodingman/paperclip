...
function TimesheetGeneratorInner() {
  ...
  const [sheetNo, setSheetNo] = useState(function () { return nextDocNumber("timesheet", "TIME-"); });
        ...
        {showHistory && (
          <div style={{ background: "#141414", border: "1px solid #2A2A2A", borderRadius: 4, padding: 12, marginBottom: 16 }}>
            ...
            {historyEntries.length === 0 ? (
              <p style={{ fontSize: 11, color: "#666", margin: 0, ...fontMono }}>Nothing yet — print a timesheet to save it here.</p>
